...
const mmap_region_t plat_k3_mmap[] = {
	...
	K3_MAP_REGION_FLAT(WKUP_CTRL_MMR0_DEVICE_MANAGEMENT_BASE, WKUP_CTRL_MMR0_DEVICE_MANAGEMENT_SIZE, MT_DEVICE | MT_RW | MT_SECURE),
	K3_MAP_REGION_FLAT(MAILBOX_TX_START_REGION, MAILBOX_SHMEM_REGION_SZ, MT_DEVICE | MT_RW | MT_SECURE),
	{ /* sentinel */ }
};
