...
static struct power_domain scmi_power_domains[] = {
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_MAIN_GPIOMUX_INTROUTER0, str(M_GPIOMX_INTR0)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_TIMESYNC_INTROUTER0, str(TIMESYNC_INTR0)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_CPT2_AGGR0, str(WK_CPT2_AGGR0)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_DMASS0_BCDMA_0, str(DMASS0_BCDMA)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_DMASS0_PKTDMA_0, str(DMASS0_PKTDM)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_DMASS0, str(WKUP_DMA0)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_DMASS0_DTHE, str(WK_DMA0_DTHE)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_DMASS0_XLCDMA_0, str(WK_DMA_XLCDMA)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_PSRAM_64K0, str(WK_PSRAM_64K0)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_ROM0, str(ROM0)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_PSC0, str(PSC0)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_DEEPSLEEP_SOURCES0, str(WK_DPSLP_SR0)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_TRNG_DRBG_EIP76D_WRAP0, str(TRNG_EIP76_WP)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_GTCCLK_SEL_DEV_VD, str(WK_GTCCLK_VD)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_OBSCLK_MUX_SEL_DEV_VD, str(WK_OBSCLK_MUX)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_CLKOUT_SEL_DEV_VD, str(WK_CLKOUT_VD)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_OBSCLK0_MUX_SEL_DEV_VD, str(OBSCLK0_MUX)),
	...
	AM62L_POWER_DOMAIN(AM62LX_DEV_COMPUTE_CLUSTER0_A53_0, str(A53_0)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_COMPUTE_CLUSTER0_A53_1, str(A53_1)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_TIMER1_CLKSEL_VD, str(TIMER1_VD)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_TIMER3_CLKSEL_VD, str(TIMER3_VD)),
	AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD, str(WKUP_TIMER_VD)),
};
