 ...
 */
#define TI_CLOCK_SW_STATE_AUTO	1
...
static ti_scmi_clock_t *ti_scmi_id_to_clock(unsigned long scmi_id)
{
...
{
	ti_scmi_clock_t *clock = ti_scmi_id_to_clock(scmi_id);
	uint32_t parent_id;
	int32_t status;
	int32_t n_parents;
...
{
	ti_scmi_clock_t *clock = ti_scmi_id_to_clock(scmi_id);
	ti_scmi_clock_t *parent = ti_scmi_id_to_clock(parent_scmi_id);
